...
export function startDatabase({ database_name }) {
  ...
  database.syncable.connect("websocket", "ws://192.168.0.111:3333").catch((err) => {
    console.error("SYNCABLE CONNECT ERROR", err);
  });

  database.syncable.on("statusChanged", function (newStatus, url) {
    console.log("URL", url);
    console.log(
